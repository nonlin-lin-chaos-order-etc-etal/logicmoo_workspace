...
chk_word(Word) :- loc_pred_prep_db(_,Word,_).
...
verb_type_db(do,aux+ditrans).
verb_type_db(have,aux+have).

verb_type_db(border,main+trans).
verb_type_db(contain,main+trans).
verb_type_db(drain,main+intrans).
verb_type_db(exceed,main+trans).
verb_type_db(flow,main+intrans).
verb_type_db(govern,main+trans).
verb_type_db(rise,main+intrans).


% =================================================================
% Specialised Dictionary

adj_db(African,restr):- agentitive_trans(_,_,African).
...
loc_pred_prep_db(of,east,prep(cp(east,of))).
loc_pred_prep_db(of,north,prep(cp(north,of))).
loc_pred_prep_db(of,south,prep(cp(south,of))).
loc_pred_prep_db(of,west,prep(cp(west,of))).
