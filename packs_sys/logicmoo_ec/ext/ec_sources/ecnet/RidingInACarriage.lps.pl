% From E: 
% 
% ':-'(call_pel_directive(translate(unskipped,'/mnt/sdc1/logicmoo_workspace.1/packs_sys/logicmoo_ec/ext/ec_sources/ecnet/RidingInACarriage.lps.pl'))).
...
:-was_s_l('/mnt/sdc1/logicmoo_workspace.1/packs_sys/logicmoo_ec/ext/ec_sources/ecnet/RidingInACarriage.e',56).
% From E: 
% 
...
% 
% '='(
%    side2(streetToLocation1), 
%    location1).
:-was_s_l('/mnt/sdc1/logicmoo_workspace.1/packs_sys/logicmoo_ec/ext/ec_sources/ecnet/RidingInACarriage.e',61).
side2(streetToLocation1,location1).

% outside BetweenLocation1And2
:-was_s_l('/mnt/sdc1/logicmoo_workspace.1/packs_sys/logicmoo_ec/ext/ec_sources/ecnet/RidingInACarriage.e',63).
% From E: 
% 
...
% 
% '='(
%    side1(streetToBetweenLocation1And2), 
%    location1).
:-was_s_l('/mnt/sdc1/logicmoo_workspace.1/packs_sys/logicmoo_ec/ext/ec_sources/ecnet/RidingInACarriage.e',68).
side1(streetToBetweenLocation1And2,location1).
...
% 
% '='(
%    side2(streetToBetweenLocation1And2), 
%    betweenLocation1And2).
:-was_s_l('/mnt/sdc1/logicmoo_workspace.1/packs_sys/logicmoo_ec/ext/ec_sources/ecnet/RidingInACarriage.e',68).
side2(streetToBetweenLocation1And2,betweenLocation1And2).

% outside Location2
:-was_s_l('/mnt/sdc1/logicmoo_workspace.1/packs_sys/logicmoo_ec/ext/ec_sources/ecnet/RidingInACarriage.e',70).
% From E: 
% 
% t(outside,location2).
...
% 
% '='(
%    side2(streetToLocation2), 
%    location2).
:-was_s_l('/mnt/sdc1/logicmoo_workspace.1/packs_sys/logicmoo_ec/ext/ec_sources/ecnet/RidingInACarriage.e',74).
side2(streetToLocation2,location2).

% outside NearLocation2
:-was_s_l('/mnt/sdc1/logicmoo_workspace.1/packs_sys/logicmoo_ec/ext/ec_sources/ecnet/RidingInACarriage.e',76).
% From E: 
% 
...
% agent Passenger1
:-was_s_l('/mnt/sdc1/logicmoo_workspace.1/packs_sys/logicmoo_ec/ext/ec_sources/ecnet/RidingInACarriage.e',83).
% From E: 
% 
% t(agent,passenger1).
...
:-was_s_l('/mnt/sdc1/logicmoo_workspace.1/packs_sys/logicmoo_ec/ext/ec_sources/ecnet/RidingInACarriage.e',106).
% From E: 
% 
...
:-was_s_l('/mnt/sdc1/logicmoo_workspace.1/packs_sys/logicmoo_ec/ext/ec_sources/ecnet/RidingInACarriage.e',136).
% From E: 
% 
% '->'(
%    ','(
%       Object\=carriageSeat1, 
%       Object\=driver1), 
%    not(released_at(
...
:-was_s_l('/mnt/sdc1/logicmoo_workspace.1/packs_sys/logicmoo_ec/ext/ec_sources/ecnet/RidingInACarriage.e',140).
% From E: 
% 
% holds(
...
:-was_s_l('/mnt/sdc1/logicmoo_workspace.1/packs_sys/logicmoo_ec/ext/ec_sources/ecnet/RidingInACarriage.e',154).
% From E: 
% 
% '->'(
%    ','(
...
:-was_s_l('/mnt/sdc1/logicmoo_workspace.1/packs_sys/logicmoo_ec/ext/ec_sources/ecnet/RidingInACarriage.e',180).
% range offset 0 0
% From E: 
% 
...
:-was_s_l('/mnt/sdc1/logicmoo_workspace.1/packs_sys/logicmoo_ec/ext/ec_sources/ecnet/RidingInACarriage.e',183).
% completion Happens
% From E: 
% 
...
% From E: 
% 
% ':-'(call_pel_directive(translate(ending,'/mnt/sdc1/logicmoo_workspace.1/packs_sys/logicmoo_ec/ext/ec_sources/ecnet/RidingInACarriage.lps.pl'))).
